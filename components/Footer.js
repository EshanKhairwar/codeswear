...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0">
      ...
      <Image className='footImg' width={200} height={40} src="/logo.png" alt="" />
     
      </Link>
      <p className="mt-3  text-sm text-gray-500 py-2 px-5 footer-para">WEAR THE &lt;CODE/&gt;-</p>
      <p className="  text-sm text-gray-500 py-2 px-5">Premium Coding T Shirts,Hoodies and Apparals</p>
    </div>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 CodeSwear-All Rights Reserved
      </p>
