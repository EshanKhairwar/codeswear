        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order Id:#889777</h1>
              ...
              <div className="flex flex-col">
                ...
                <div className='my-5 w-36'>
                  <Link href='/trackorder' className="flex mx-0 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">
