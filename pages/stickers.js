      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-2 justify-center">
            {Object.keys(products).length===0 && <p>Sorry all the Stickers are currently Out of Stock.New Stock Coming soon!!!Come back again</p>}
            {Object.keys(products)?.map((item) => {
            
              return (


                <Link passHref={true}  key={products[item]._id} href={`/product/${products[item].slug}`} className="lg:w-1/5 md:w-1/2 p-4 w-full shadow-lg m-5">

                  <div >
                    <div className="block relative  rounded overflow-hidden">
                      <img alt="ecommerce" className=" m-auto h-[50vh] block" src={products[item].img} />
                    </div>
