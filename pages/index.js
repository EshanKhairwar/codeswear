...
export default function Home() {
  return (
    <>
      <Head>
        <title>CodeSwear -Coding Culture Unleash Your Digital Style</title>
        <meta
          name="description"
          content="CodesWear.com -Coding Culture Unleash Your Digital Style"
        />
      </Head>
  
      <div>
        <img src="/HomeBanner.jpg" alt="" />
      </div>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      ...
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want!!! But why not Code!!!</p>
    </div>
